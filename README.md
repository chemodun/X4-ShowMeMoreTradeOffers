...
- Available only from game version `8.00HF3` and newer, due to reliance on the latest version of the `UI Extensions and HUD` mod.
...
- You can download the latest version via Steam client - [Show Me More Trade Offers](https://steamcommunity.com/sharedfiles/filedetails/?id=3624666582)
  - Due to absence the `UI Extensions and HUD` mod on Steam and some limitations of Steam Workshop please be sure that you have installed and enabled the `UI Extensions and HUD` mod by `kuertee` of version `8.035` or newer.
...
- Trade offers limited by default maximum value:
  ![Trade offers limited by default maximum value](docs/images/trade_offers_with_default_maximum_value.png)
- Trade Filters menu with updated maximum value:
  ![Trade Filters menu with updated maximum value](docs/images/trade_filters_with_updated_maximum_value.png)
- Trade offers are restricted to a suitable value, though not the maximum:
  ![Trade offers are restricted to a suitable value, though not the maximum](docs/images/trade_offers_with_new_value.png)
